...
export const mockOrganizations: Organization[] = [
  ...
  },
  {
    ...
    description:
      "Dedicated to safeguarding biodiversity and empowering communities in the greater Tsavo Ecosystem.",
    websiteUrl: "https://wildlifeconservationkenya.org",
    logoUrl: "/tsavo-trust-1.png",
    country: "Kenya",
  },
  {
    id: 3,
